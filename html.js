...
async function fetchRecordByRoll(roll) {
  try {
    ...
    const rollColIndex = 2; // रोल नंबर अब 3rd कॉलम में है, इसलिए इंडेक्स 2 (0 से गिना जाता है)
...
function displayFields(fields) {
  ...
  document.getElementById("msNub").innerText        = fields['Ms_Nub'] || "N/A";
  document.getElementById("studentName").innerText  = fields['NAME'] || "N/A"; 
  document.getElementById("t1").innerText           = fields['1st Terminal'] || "N/A";
  document.getElementById("t2").innerText           = fields['2nd Terminal'] || "N/A";
